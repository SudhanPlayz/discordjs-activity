...
client.on("message", async (message) => {
    ...
    if(message.content === "youtube"){
        ...
        let Invite = await VoiceChannel.activityInvite("755600276941176913")//Application Name [youtube_together, fishington, chess_in_the_park, betrayal, poker_night, chess_in_the_park_dev]
        if(Invite) {
